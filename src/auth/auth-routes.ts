...
const authRoutePaths = new Set(['/login', '/register', '/forgot-password', '/reset-password', '/verify-email', '/native-auth-complete', '/oauth/callback', '/oauth/link', '/oauth/onboarding', '/line/bind'])
